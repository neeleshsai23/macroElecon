...
@Component({
  selector: 'app-client-exceptions-cardview',
  templateUrl: './client-exceptions-cardview.component.html',
  styleUrls: ['./client-exceptions-cardview.component.scss']
})
export class ClientExceptionsCardviewComponent implements OnInit {
